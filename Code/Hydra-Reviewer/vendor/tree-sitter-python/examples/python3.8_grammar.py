...
from TMP_OLD.test import check_syntax_error
import inspect
import unittest
# testing import *
...
from TMP_OLD import test as ann_module, test
import typing
from TMP_OLD.test import ann_module2
...
class GrammarTests(unittest.TestCase):
    ...
    def test_var_annot_in_module(self):
        ...
        from TMP_OLD.test import f_bad_ann, g_bad_ann, D_bad_ann
        with self.assertRaises(NameError):
            f_bad_ann()
        with self.assertRaises(NameError):
            g_bad_ann()
